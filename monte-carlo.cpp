...
void monte_carlo_both_price(result_type &result)
{
  ...
  // #pragma HLS bind_op variable=call_payoff_sum_arr op=fadd impl=primitivedsp latency=1
  // #pragma HLS bind_op variable=put_payoff_sum_arr op=fadd impl=primitivedsp latency=1
