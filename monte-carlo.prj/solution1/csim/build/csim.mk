...
HLS_SOURCES = ../../../../monte-carlo_test.cpp ../../../../monte-carlo.cpp
...
$(ObjDir)/monte-carlo_test.o: ../../../../monte-carlo_test.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../monte-carlo_test.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD -std=c++11 -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) -DNDEBUG $< -o $@ ; \

-include $(ObjDir)/monte-carlo_test.d

$(ObjDir)/monte-carlo.o: ../../../../monte-carlo.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../monte-carlo.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD -std=c++11  $(IFLAG) $(DFLAG) -DNDEBUG $< -o $@ ; \

-include $(ObjDir)/monte-carlo.d
