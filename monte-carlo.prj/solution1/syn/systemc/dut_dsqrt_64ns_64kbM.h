...
// ==============================================================
#ifndef __dut_dsqrt_64ns_64kbM__HH__
#define __dut_dsqrt_64ns_64kbM__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(dut_dsqrt_64ns_64kbM) {
    ...
    SC_CTOR(dut_dsqrt_64ns_64kbM):  ACMP_dsqrt_U ("ACMP_dsqrt_U") {
