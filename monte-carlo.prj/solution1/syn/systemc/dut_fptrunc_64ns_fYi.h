...
// ==============================================================
#ifndef __dut_fptrunc_64ns_fYi__HH__
#define __dut_fptrunc_64ns_fYi__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(dut_fptrunc_64ns_fYi) {
    ...
    SC_CTOR(dut_fptrunc_64ns_fYi):  ACMP_fptrunc_U ("ACMP_fptrunc_U") {
