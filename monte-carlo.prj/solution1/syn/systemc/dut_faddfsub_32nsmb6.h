...
// ==============================================================
#ifndef __dut_faddfsub_32nsmb6__HH__
#define __dut_faddfsub_32nsmb6__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(dut_faddfsub_32nsmb6) {
    ...
    SC_CTOR(dut_faddfsub_32nsmb6):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
