...
// ==============================================================
#ifndef __dut_sitofp_32s_32eOg__HH__
#define __dut_sitofp_32s_32eOg__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(dut_sitofp_32s_32eOg) {
    ...
    SC_CTOR(dut_sitofp_32s_32eOg):  ACMP_sitofp_U ("ACMP_sitofp_U") {
