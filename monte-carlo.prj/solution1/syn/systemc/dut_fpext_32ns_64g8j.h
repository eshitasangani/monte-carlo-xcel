...
// ==============================================================
#ifndef __dut_fpext_32ns_64g8j__HH__
#define __dut_fpext_32ns_64g8j__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(dut_fpext_32ns_64g8j) {
    ...
    SC_CTOR(dut_fpext_32ns_64g8j):  ACMP_fpext_U ("ACMP_fpext_U") {
